...
const url = apod.url;
  ...
  let sql = `INSERT INTO nasa(copyright, download_date, title, url, explanation) VALUES ("${copyright}", "${date}", "${title}", "${url}", "${explanation}");`;
  //let sql = `INSERT INTO astronomy_app.api_downloaded(copyright, download_date, title, url, explanation) VALUES ("${copyright}", "${date}", "${title}", "${url}", "${explanation}");`;
